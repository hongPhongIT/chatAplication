...
class App extends Component {
  ...
  componentDidMount () {
    ...
    script.src = "http://localhost:3000/js/script.js";
    script.async = true;
              ...
              <div className="card-body contacts_body">
                <div className="contacts">
                  <li className="active">
                    <div className="d-flex bd-highlight">
                      <div className="img_cont">
                        <img alt="thumbnail" src="https://devilsworkshop.org/files/2013/01/enlarged-facebook-profile-picture.jpg" className="rounded-circle user_img" />
                  ...
                  <li>
                    <div className="d-flex bd-highlight">
                      <div className="img_cont">
                        <img alt="thumbnail" src="https://2.bp.blogspot.com/-8ytYF7cfPkQ/WkPe1-rtrcI/AAAAAAAAGqU/FGfTDVgkcIwmOTtjLka51vineFBExJuSACLcBGAs/s320/31.jpg" className="rounded-circle user_img" />
                  ...
                  <li>
                    <div className="d-flex bd-highlight">
                      <div className="img_cont">
                        <img alt="thumbnail" src="https://i.pinimg.com/originals/54/6e/6d/546e6d4c6ce4322e6aa3b2f8ca73ac28.jpg" className="rounded-circle user_img" />
                        <span className="online_icon" />
                      </div>
                      <div className="user_info">
                  ...
                  <li>
                    <div className="d-flex bd-highlight">
                      <div className="img_cont">
                        <img alt="thumbnail" src="http://profilepicturesdp.com/wp-content/uploads/2018/07/sweet-girl-profile-pictures-9.jpg" className="rounded-circle user_img" />
                        <span className="online_icon offline" />
                      </div>
                      <div className="user_info">
                  ...
                  <li>
                    <div className="d-flex bd-highlight">
                      <div className="img_cont">
                        <img alt="thumbnail" src="https://www.freshmorningquotes.com/wp-content/uploads/2015/11/cute-and-beautifull-girls-profile-pictures.jpg" className="rounded-circle user_img" />
                        <span className="online_icon offline" />
                      </div>
                      <div className="user_info">
            ...
            <div className="card">
              ...
              <div className="card-body msg_card_body">
                <div className="d-flex justify-content-start mb-4">
                  <div className="img_cont_msg">
                    <img alt="thumbnail" src="https://devilsworkshop.org/files/2013/01/enlarged-facebook-profile-picture.jpg" className="rounded-circle user_img_msg" />
                  </div>
              ...
              <div className="card-footer">
                <div className="input-group">
                  ...
                  <textarea rows={3} className="form-control type_msg" placeholder="Type your message..." defaultValue={""} />
                  <div className="input-group-append">
            ...
            <div className="card mb-sm-3 mb-md-0 contacts_card">
              <div className="card-body contacts_body">
                <div className="active">
                  <div className="d-flex bd-highlight">
                    ...
                    <div style={{paddingLeft: '150px', paddingTop: '20px'}}>
                      <span style={{color: 'aliceblue', fontSize: '20px'}}>
                ...
                <div className="pos-f-t">
                  <nav className="navbar navbar-dark nav-border">
                    <button className="navbar-toggler crossRotate" style={{marginLeft: '90%'}} type="button" data-toggle="collapse" data-target="#navbarToggleExternalContent" aria-controls="navbarToggleExternalContent" aria-expanded="false" aria-label="Toggle navigation">
                ...
                <div className="pos-f-t">
                  <nav className="navbar navbar-dark nav-border">
                    <button className="navbar-toggler crossRotate" style={{marginLeft: '90%'}} type="button" data-toggle="collapse" data-target="#navbarToggleExternalContent1" aria-controls="navbarToggleExternalContent" aria-expanded="false" aria-label="Toggle navigation">
                      <i className="fas fa-angle-left" />
                    </button>
                  </nav>
